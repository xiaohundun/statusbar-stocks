...
public class PluginSettingsComponent {
    ...
    private final JBCheckBox colorVisible = new JBCheckBox("显示颜色");
    ...
    public PluginSettingsComponent() {
        ...
        colorVisible.setSelected(AppSettingsState.getInstance().colorVisible);
    ...
    public boolean getColorVisible() {
        return colorVisible.isSelected();
    }

    public void setColorVisible(boolean visible) {
        colorVisible.setSelected(visible);
    }
}
